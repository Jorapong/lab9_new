...
import com.example.lab9_mysqlupdatedelete.EditStudentsActivity
import com.example.lab9_mysqlupdatedelete.R
...
class EditStudentsAdapter(val items :List<Student>, val context: Context):RecyclerView.Adapter<EditStudentsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        view_item.setOnClickListener() {
            ...
            val intent = Intent(context, EditStudentsActivity::class.java)
